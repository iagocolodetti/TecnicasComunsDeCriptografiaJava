...
public class FrameCC extends javax.swing.JFrame {
    public FrameCC() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lDeslocamento = new javax.swing.JLabel();
        tfDeslocamento = new javax.swing.JTextField();
        ...
        lDeslocamento.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 14)); // NOI18N
        lDeslocamento.setText("Deslocamento:");

        tfDeslocamento.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 14)); // NOI18N
        tfDeslocamento.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(376, 376, 376)
                        .addComponent(lDeslocamento)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tfDeslocamento, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(328, 328, 328)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lDeslocamento)
                    .addComponent(tfDeslocamento, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btCifrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCifrarActionPerformed
        ...
        try {
            ...
            if(mu.intTryParse(tfDeslocamento.getText())) {
                taResultado.setText(c.Cifrar(taTexto.getText(), Integer.parseInt(tfDeslocamento.getText()), 32, 255));
            } else javax.swing.JOptionPane.showMessageDialog(null, "Digite um número inteiro para efetuar o deslocamento.", "Erro", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
        catch (Exception ex) {
    ...
    private void btVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btVoltarActionPerformed
        // TODO add your handling code here:
        FramePrincipal fp = new FramePrincipal(1);
        fp.setVisible(true);
    ...
    private void btDecifrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDecifrarActionPerformed
        ...
        try {
            ...
            MetodosUteis mu = new MetodosUteis();
            if(mu.intTryParse(tfDeslocamento.getText())) {
                taResultado.setText(c.Decifrar(taTexto.getText(), Integer.parseInt(tfDeslocamento.getText()), 32, 255));
            } else javax.swing.JOptionPane.showMessageDialog(null, "Digite um número inteiro para efetuar o deslocamento.", "Erro", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
        catch (Exception ex) {
            javax.swing.JOptionPane.showMessageDialog(null, ex.getMessage(), "Erro", javax.swing.JOptionPane.ERROR_MESSAGE);
    ...
    private javax.swing.JLabel lDeslocamento;
    ...
    private javax.swing.JTextField tfDeslocamento;
